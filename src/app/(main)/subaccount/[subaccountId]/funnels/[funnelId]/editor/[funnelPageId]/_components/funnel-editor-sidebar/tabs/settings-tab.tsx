  ...
  return (
    ...
    >
      ...
      >
        ...
        <AccordionContent>
          {(state.editor.selectedElement.type ===  'textinput' ||
          state.editor.selectedElement.type ===  'numberinput' ||
          state.editor.selectedElement.type ===  'dateinput' ||
          state.editor.selectedElement.type ===  'emailinput' ||
             ...
             (
              <div className="flex flex-col gap-2">
                ...
                <Input
                  ...
                  onChange={handleChangeCustomValues}
                  value={state.editor.selectedElement.content.placeholder}
                />
              </div>
            )}
        </AccordionContent>
